# -*- coding: utf-8 -*-
"""Pentagram_Music_Transformer_Maker_X_DP.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XuE1K0IFDl1ukfayaQv98aWBt2upc1RJ

# Pentagram Music Transformer Maker: X Transformer DataParallel Edition (ver. 1.0)
...
#x = (torch.tensor(random.choice(train_data)[:7500], dtype=torch.long, device=device_type)[None, ...])
x = torch.tensor([[1669, 1669, 1669, 1538+1, 1540+40]] * 4, dtype=torch.long, device=device_type)
...
print('Sample INTs', y[batch_number][:15])
