# -*- coding: utf-8 -*-
"""Pentagram_Music_Transformer_Training_Dataset_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xLG8E9b7etPzLPDLyaZdhCk-59Xlq8L0

# Pentagram Music Transformer Training Dataset Maker (ver. 1.0)
            ...
            if min([e[1] for e in events_matrix1]) >= 0 and min([e[2] for e in events_matrix1]) >= 0:
              ...
              if len(events_matrix1) > 0 and len(instruments_list_without_drums) > 0:
                ...
                for m in melody_chords:
                    ...
                    if (len(melody_chords) - note_counter) == 100:
